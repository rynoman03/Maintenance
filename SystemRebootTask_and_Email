...
$Trigger =
          New-ScheduledTaskTrigger -Once -At '6:00AM'
Register-ScheduledTask -Action $Action -Principal $Principal -Trigger $Trigger -Taskname "SystemRebootTask_and_Email" -Description "Reboot system at scheduled time and send email via smtp server"
#
